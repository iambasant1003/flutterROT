...
import 'package:rupeeontime/Model/CheckBankStatementStatusModel.dart';
import 'package:rupeeontime/Model/CreateLeadModel.dart';
import 'package:rupeeontime/Model/GenerateLoanOfferModel.dart';
import 'package:rupeeontime/Model/UpdateBankAccountModel.dart';
import 'package:rupeeontime/Model/UploadSelfieModel.dart';
import 'package:rupeeontime/Screens/Repayment/payment_screen.dart';
import 'package:rupeeontime/Screens/TermsAndCondition/terms_and_condition.dart';
import 'package:rupeeontime/Screens/auth/login_page.dart';
import 'package:rupeeontime/Screens/auth/verify_otp.dart';
import 'package:rupeeontime/Screens/dashboard/dashboard_page.dart';
import 'package:rupeeontime/Screens/dashboard/dashboard_status.dart';
import 'package:rupeeontime/Screens/dashboard/dashboard_verify_otp.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/addReferance/add_reference.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/bankStatement/bank_statement.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/bankStatement/newBREJourney/bank_statement_analyzer.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/bankStatement/onlinebankStatement/online_bank_statement.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/bankStatement/onlinebankStatement/online_banking_message.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/bankingDetails/banking_details.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/checkEligibility/check_eligibility.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/checkEligibility/eligibility_status.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/eKyc/customer_kyc_webview.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/loanOffer/loan_offer.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/loanOffer/loan_offer_failed.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/selfieVerification/selfie_uploaded.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/selfieVerification/selfie_verification.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loanApplicationOptions/utilityBills/utility_bills.dart';
import 'package:rupeeontime/Screens/loanApplicationPage/loan_application_page.dart';
